(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{firstName:`Danny`,lastName:`Nickel`,email:`danny.nickel@sml.ca`,company:`Strathcona Mechanical Limited`,jobTitle:`Senior Estimator`,phone:`+1 (780) 980-1122`,location:`—`,source:`OUTLOOK`,latitude:53.5461,longitude:-113.4938,createdAt:new Date(Date.now()-22*36e5).toISOString()},{firstName:`Jackson`,lastName:`Carcueva`,email:`jacksonc@ener-spray.ca`,company:`Licensed Applicator for:`,jobTitle:`Project Manager`,phone:`—`,location:`—`,source:`OUTLOOK`,latitude:49.2827,longitude:-123.1207,createdAt:new Date(Date.now()-22*36e5).toISOString()},{firstName:`Kathy`,lastName:`O'Hanley`,email:`kathy.ohanley@flynncompa...`,company:`A member of the Flynn Group of Companies`,jobTitle:`Estimating Manager`,phone:`+1 (250) 448-2675`,location:`—`,source:`OUTLOOK`,latitude:48.4284,longitude:-123.3656,createdAt:new Date(Date.now()-22*36e5).toISOString()},{firstName:`Estimation`,lastName:`- AJPH`,email:`Estimation@ajph.com`,company:`Ajph`,jobTitle:`—`,phone:`—`,location:`—`,source:`OUTLOOK`,latitude:45.5017,longitude:-73.5673,createdAt:new Date(Date.now()-22*36e5).toISOString()},{firstName:`Tim`,lastName:`Christensen`,email:`tim@islandmetalcraft.ca`,company:`Islandmetalcraft`,jobTitle:`—`,phone:`+1 (250) 383-4815`,location:`A: 540 William Street`,source:`OUTLOOK`,latitude:48.4284,longitude:-123.3656,createdAt:new Date(Date.now()-22*36e5).toISOString()},{firstName:`Kathy`,lastName:`Parkinson`,email:`kathy@ravensc.ca`,company:`Owner - RavenStone Constr...`,jobTitle:`CFO`,phone:`+1 (250) 748-7700`,location:`—`,source:`OUTLOOK`,latitude:48.7767,longitude:-123.7058,createdAt:new Date(Date.now()-23*36e5).toISOString()},{firstName:`Brad`,lastName:`Greenbank`,email:`brad@alpharoofing.ca`,company:`Alpha Roofing & Cladding Inc`,jobTitle:`Director`,phone:`+1 (250) 544-0169`,location:`—`,source:`OUTLOOK`,latitude:49.1666,longitude:-123.9401,createdAt:new Date(Date.now()-23*36e5).toISOString()},{firstName:`Grant`,lastName:`MacDonald`,email:`grant.macdonald@teamhori...`,company:`Teamhorizon`,jobTitle:`Preconstruction Manager`,phone:`+1 (604) 533-9757`,location:`27078 56 Ave`,source:`OUTLOOK`,latitude:49.1044,longitude:-122.6609,createdAt:new Date(Date.now()-24*36e5).toISOString()},{firstName:`dalcon`,lastName:`@shaw.ca Roys`,email:`dalcon@shaw.ca`,company:`Business Admin. &`,jobTitle:`—`,phone:`+1 (250) 743-1449`,location:`Physical Address: Unit B 148...`,source:`OUTLOOK`,latitude:48.7438,longitude:-123.7088,createdAt:new Date(Date.now()-24*36e5).toISOString()},{firstName:`Mathew`,lastName:`Schultz`,email:`Mathew.Schultz@norlandlim...`,company:`Norlandlimited`,jobTitle:`Preconstruction Manager`,phone:`+1 (250) 748-3132`,location:`Address: 8338 Crofton Rd, ...`,source:`OUTLOOK`,latitude:48.8612,longitude:-123.6523,createdAt:new Date(Date.now()-25*36e5).toISOString()},{firstName:`Anand`,lastName:`Mitchell`,email:`Anand.Mitchell@norlandlimi...`,company:`Norlandlimited`,jobTitle:`Project Manager`,phone:`21010108`,location:`British Columbia Branch: 29...`,source:`OUTLOOK`,latitude:49.2488,longitude:-122.9805,createdAt:new Date(Date.now()-25*36e5).toISOString()},{firstName:`Joseph Nello`,lastName:`Conti`,email:`JConti@vikingfire.ca`,company:`Vikingfire`,jobTitle:`Representative`,phone:`+1 (604) 324-7122`,location:`—`,source:`OUTLOOK`,latitude:49.227,longitude:-123.0032,createdAt:new Date(Date.now()-26*36e5).toISOString()},{firstName:`Sarah`,lastName:`Williams`,email:`sarah.williams@acme.com`,company:`Acme Corp`,jobTitle:`Engineer`,phone:`+1 (415) 555-0101`,location:`San Francisco, CA`,source:`OUTLOOK`,latitude:37.7749,longitude:-122.4194,createdAt:new Date(Date.now()-48*36e5).toISOString()},{firstName:`Michael`,lastName:`Chen`,email:`m.chen@techcorp.com`,company:`TechCorp`,jobTitle:`VP Engineering`,phone:`+1 (512) 555-0202`,location:`Austin, TX`,source:`OUTLOOK`,latitude:30.2672,longitude:-97.7431,createdAt:new Date(Date.now()-72*36e5).toISOString()},{firstName:`Emily`,lastName:`Rodriguez`,email:`e.rodriguez@buildco.com`,company:`BuildCo`,jobTitle:`Operations Manager`,phone:`+1 (305) 555-0303`,location:`Miami, FL`,source:`OUTLOOK`,latitude:25.7617,longitude:-80.1918,createdAt:new Date(Date.now()-96*36e5).toISOString()},{firstName:`James`,lastName:`Thompson`,email:`j.thompson@pacific.ca`,company:`Pacific Developments`,jobTitle:`Site Manager`,phone:`+1 (604) 555-0404`,location:`Vancouver, BC`,source:`OUTLOOK`,latitude:49.2827,longitude:-123.1207,createdAt:new Date(Date.now()-120*36e5).toISOString()},{firstName:`Lisa`,lastName:`Park`,email:`l.park@northbuild.ca`,company:`North Build Solutions`,jobTitle:`Estimator`,phone:`+1 (604) 555-0505`,location:`Surrey, BC`,source:`OUTLOOK`,latitude:49.1913,longitude:-122.849,createdAt:new Date(Date.now()-144*36e5).toISOString()},{firstName:`Robert`,lastName:`Singh`,email:`r.singh@westcoast.ca`,company:`West Coast Electric`,jobTitle:`Electrician`,phone:`+1 (604) 555-0606`,location:`Burnaby, BC`,source:`OUTLOOK`,latitude:49.2488,longitude:-122.9805,createdAt:new Date(Date.now()-168*36e5).toISOString()},{firstName:`Amanda`,lastName:`Foster`,email:`a.foster@islandpaving.ca`,company:`Island Paving`,jobTitle:`Admin Manager`,phone:`+1 (250) 555-0707`,location:`Nanaimo, BC`,source:`OUTLOOK`,latitude:49.1659,longitude:-123.9401,createdAt:new Date(Date.now()-192*36e5).toISOString()},{firstName:`Derek`,lastName:`Huang`,email:`d.huang@rapidconcrete.ca`,company:`Rapid Concrete`,jobTitle:`Foreman`,phone:`+1 (604) 555-0808`,location:`Langley, BC`,source:`OUTLOOK`,latitude:49.1044,longitude:-122.6609,createdAt:new Date(Date.now()-216*36e5).toISOString()},...Array.from({length:41},(e,t)=>({firstName:`Alex.Chris.Jordan.Taylor.Morgan.Casey.Riley.Drew.Blake.Quinn.Avery.Cameron.Dakota.Emery.Finley.Harper.Hayden.Jamie.Jesse.Kelly.Lane.Logan.Marley.Nico.Oakley.Parker.Peyton.Reese.Rowan.Sage.Sawyer.Skyler.Spencer.Sydney.Tatum.Toby.Val.Wesley.Wren.Zion.Ash`.split(`.`)[t],lastName:`Brown.Davis.Garcia.Harris.Jackson.Jones.Lee.Martin.Miller.Moore.Nelson.Patel.Reed.Roberts.Scott.Smith.Taylor.Thomas.Walker.White.Wilson.Wright.Young.Adams.Allen.Baker.Carter.Clark.Collins.Cook.Edwards.Evans.Green.Hall.Hill.King.Lewis.Long.Mitchell.Morris.Murphy`.split(`.`)[t],email:`contact${t+20}@company.com`,company:`Bird.Bird.Bird.Bird.Bird.Ledcor.Ledcor.PCL.PCL.Graham.EllisDon.Aecon.Chandos.Pomerleau.Whitewater.Peak.Summit.Vertex.Cascade.Alpine.Horizon.Matrix.Pinnacle.Nova.Atlas.Forge.Keystone.Sterling.Patriot.Vanguard.Titan.Apex.Nexus.Prism.Crown.Delta.Echo.Falcon.Griffin.Harbor.Iron`.split(`.`)[t],jobTitle:`Project Manager.Project Manager.Project Manager.Estimator.Estimator.Project Manager.Superintendent.Estimator.Project Manager.Project Manager.Coordinator.Engineer.Designer.Foreman.Inspector.Planner.Analyst.Director.Manager.Supervisor.Consultant.Advisor.Specialist.Lead.Coordinator.Technician.Operator.Assistant.Associate.Senior PM.VP Operations.Site Lead.QC Manager.Safety Officer.Scheduler.Procurement.Contracts.BIM Lead.Surveyor.Drafter.Laborer`.split(`.`)[t],phone:`+1 (${600+t}) 555-${String(1e3+t).slice(-4)}`,location:`—`,source:`OUTLOOK`,latitude:49.2+(Math.random()-.5)*2,longitude:-123.1+(Math.random()-.5)*2,createdAt:new Date(Date.now()-(240+t*24)*36e5).toISOString()}))];function t(){let t={};return e.forEach(e=>{t[e.company]=(t[e.company]||0)+1}),Object.entries(t).sort((e,t)=>t[1]-e[1])[0]?.[0]||`—`}function n(){let t={};return e.forEach(e=>{e.jobTitle&&e.jobTitle!==`—`&&(t[e.jobTitle]=(t[e.jobTitle]||0)+1)}),Object.entries(t).sort((e,t)=>t[1]-e[1])[0]?.[0]||`—`}function r(e){let t=Date.now()-new Date(e).getTime(),n=Math.floor(t/36e5);if(n<1)return`just now`;if(n<24)return`${n} hours ago`;let r=Math.floor(n/24);return`${r} day${r>1?`s`:``} ago`}function i(e){return((e.firstName?.[0]||``)+(e.lastName?.[0]||``)).toUpperCase()}var a=[`#4ade80`,`#f472b6`,`#60a5fa`,`#fbbf24`,`#a78bfa`,`#34d399`,`#fb923c`,`#818cf8`,`#f87171`,`#2dd4bf`];function o(e){let t=0;for(let n=0;n<e.length;n++)t=e.charCodeAt(n)+((t<<5)-t);return a[Math.abs(t)%a.length]}function s(a){let s=[...e].sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()).slice(0,5),l=t(),u=n();a.innerHTML=`
